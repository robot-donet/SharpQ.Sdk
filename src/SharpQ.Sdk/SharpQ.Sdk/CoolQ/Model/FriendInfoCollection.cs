...
namespace SharpQ.Sdk.CoolQ.Model
{
	...
	/// </summary>
	public sealed class FriendInfoCollection : BasisCollectionModel<FriendInfo>
	{
		#region --构造函数--
		/// <summary>
		///  使用指定的密文初始化 <see cref="FriendInfoCollection"/> 类的新实例, 并持有用于扩展方法的 <see cref="CQApi"/> 实例
		/// </summary>
		...
		public FriendInfoCollection (CQApi api, byte[] ciphertext)
			: base (api, ciphertext)
		{ }
		#endregion
		...
		public override string ToString ()
		{
			...
			builder.AppendLine ("[");
			foreach (FriendInfo friend in this)
			{
		...
		protected override void Initialize (BinaryReader reader)
		{
			...
			for (int i = 0; i < count; i++)
			{
				...
				this._list.Add (new FriendInfo (this.Api, reader.ReadToken_Ex ()));
			}
		}
		#endregion
	}
